...
the billing and advertising implementation. The website's existing styles and assets
...
Android resources. Keep material claims aligned with this policy and the billing
retention mechanism documented in `../api-contract.md`.
